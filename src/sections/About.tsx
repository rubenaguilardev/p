...
const About = () => {
  return (
    <section id='about' className='py-32 relative overflow-hidden'>
      <div className='relative mx-auto px-6 lg:px-10 z-10'>
        <div className='grid lg:grid-cols-2 gap-16 items-center'>
          <div className='space-y-8'>
            ...
            <div className="glass glow-border rounded-2xl p-6 animate-fade-in animation-delay-300">
              <p className="text-lg font-medium italic text-foreground">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ullam nihil molestias, blanditiis soluta fuga alias fugiat expedita mollitia ut quas id possimus culpa quam inventore voluptate sit. Dolorum, aspernatur est.</p>
            </div>
          </div>
